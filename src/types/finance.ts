...
export interface FeatureCard { title: string; subtitle: string; valueLabel?: string; value: string; button: string; icon: IconName; tone: Tone; href?: string }
...
export interface QuickAction { title: string; description: string; icon: IconName; tone: Tone; href?: string }
