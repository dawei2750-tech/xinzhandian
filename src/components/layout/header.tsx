...
export function Header() {
  return <header className="relative z-20 border-b border-line bg-canvas/80 backdrop-blur-xl">
    <div className="mx-auto flex h-nav-h max-w-content items-center gap-8 px-page sm:px-6">
      <a href="#home" className="flex shrink-0 items-center gap-3 font-semibold"><span className="grid size-9 place-items-center rounded-control bg-brand-gradient p-2 text-ink shadow-glow"><Icon name="chain" className="size-full drop-shadow-icon"/></span><span className="text-lg">{brand.name}</span></a>
