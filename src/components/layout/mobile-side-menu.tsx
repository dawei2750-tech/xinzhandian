...
export function MobileSideMenu() {
  ...
  const drawer = <div id="mobile-menu-drawer" data-testid="mobile-drawer" className="mobile-drawer-panel fixed inset-0 z-[80] lg:hidden">
    ...
    <aside className="relative flex h-full w-[82%] max-w-sm flex-col overflow-y-auto border-r border-line-bright bg-canvas p-5 shadow-2xl">
      <div className="flex items-center justify-between">
        ...
        <a href="#home" aria-label={text.common.closeMenu} className="grid size-10 cursor-pointer place-items-center rounded-full border border-line text-xl text-muted">x</a>
      </div>
  ...
  return <div className="mobile-side-menu lg:hidden">
    <a href="#mobile-menu-drawer" aria-label={text.common.openMenu} className="grid size-10 shrink-0 cursor-pointer place-items-center rounded-control border border-line bg-surface-soft">
